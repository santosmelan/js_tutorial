...
console.log(imperativeUrls2(states));
...
function functionalUrls3(elements) {
	return elements.map(element => `https://example.com/${urlify(element)}` )
}
console.log(functionalUrls3(states));

function s() {
	return [1, 2, 3, 4].map(n => n*n);
	//return [1, 2, 3, 4].map(function(n) { n * n; });
}
console.log(s());
